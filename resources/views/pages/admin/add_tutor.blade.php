        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="edit-profile">
              <div class="row">
                <div class="col-xl-12">
                  <form class="card" method="POST" action="{{ route('addT') }}">
                    @csrf
                    <div class="card-body">
                    @if (session('success'))
                      <div class="alert alert-success" role="alert" style="border-radius: 0px;">
                          {{ __('Lecturer added successfully!.') }}
                      </div>
                    @endif
                      <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <div>
                            <label class="form-label">Lecturing Course</label>
                    ...
                    <div class="card-footer text-end">
                      <button class="btn btn-primary" type="submit">Add Student</button>  <a class="btn btn-danger" href="/admin/tutors">Cancle</a>
                    </div>
                  </form>
                </div>
              </div>
