            ...
            <div class="form-group w-100">
              <div class="Typeahead Typeahead--twitterUsers">
                <div class="u-posRelative">
                  <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder="Search NIIT.." name="q" title="" autofocus>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown"><i data-feather="message-square"></i>
                <ul class="chat-dropdown onhover-show-div">
                  ...
                  <li>
                    <div class="media"><img class="img-fluid rounded-circle me-3" src="{{ asset('/images/user/4.jpg')}}" alt="">
                  ...
                  <li class="text-center"> <a class="btn btn-primary" href="javascript:void(0)">View All</a></li>
                </ul>
              </li>
              <li class="maximize"><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()"><i data-feather="maximize"></i></a></li>
              <li class="profile-nav onhover-dropdown p-0 me-0">
                <div class="media profile-media"><img class="b-r-10" src="{{ asset('/images/dashboard/profile.jpg')}}" alt="">
                  <div class="media-body"><span>{{ ucfirst(Auth::user()->first_name) }} {{ ucfirst(Auth::user()->last_name) }}</span>
                    <p class="mb-0 font-roboto">{{ ucfirst(Auth::user()->roles) }} <i class="middle fas fa-angle-down"></i></p>
                  </div>
                </div>
